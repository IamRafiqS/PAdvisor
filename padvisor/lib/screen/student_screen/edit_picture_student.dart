...
class editPictureStudent extends StatefulWidget {
  @override
  _editPictureStudentState createState() => _editPictureStudentState();
}

class _editPictureStudentState extends State<editPictureStudent> {
  ...
  void uploadFile() async {
    ...
    UploadImage.saveImageUrlToFirebaseStudent(uploadTask, uid);
  }
}
